...
import { Button, Col, FormGroup, Row } from '@triniti/admin-ui-plugin/components';
            ...
            <FormGroup>
              ...
              {asset.schema().getCurie().getMessage() === 'image-asset' && (
                <>
                  ...
                  <Field name="altText" component={TextField} label="Alt Text" placeholder="Alternative information" defaultValue={""} size="sm" />
                </>
              )}
            </FormGroup>
          </Col>
              ...
              <Col>
                <FormGroup>
                  <Field
                    ...
                    label="Credit"
                    name="credit"
                    picklistId={getPicklistId(activeHashName, asset)}
                    size="sm"
                  />
                </FormGroup>
              </Col>
