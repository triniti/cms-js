...
const ArchiveAssetFields = ({ asset, isEditMode, schemas }) => ([
  <Card key="asset">
    <CardHeader>Archive Asset</CardHeader>
    <CardBody indent>
      ...
      <Field
        ...
        label="Credit"
        name="credit"
        picklistId="archive-asset-credits"
      />
      <Field
        name="creditUrl"
        component={TextField}
...
ArchiveAssetFields.propTypes = {
  asset: PropTypes.instanceOf(Message).isRequired,
  isEditMode: PropTypes.bool,
};

ArchiveAssetFields.defaultProps = {
  isEditMode: false,
};

export default ArchiveAssetFields;
