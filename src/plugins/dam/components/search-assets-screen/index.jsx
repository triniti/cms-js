...
import { ErrorBoundary, Icon, Loading, Pager, Screen, withForm } from '@triniti/cms/components';
...
import SearchForm from '@triniti/cms/plugins/dam/components/search-assets-screen/SearchForm';
...
//const CreateAssetModal = lazy(() => import('@triniti/cms/plugins/dam/components/create-asset-modal'));
