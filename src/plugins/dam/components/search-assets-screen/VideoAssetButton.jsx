...
export default function VideoAssetButton({asset, currentlyPlayingAssetId, onPlayerCommand }) {
    ...
    return (
          ...
          <Button
            ...
            onClick={() => {
              if(command === 'stop') { onPlayerCommand('stop', currentlyPlayingAssetId, {width:'0', height: '0'}) } 
