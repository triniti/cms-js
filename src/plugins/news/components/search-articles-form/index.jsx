...
class SearchArticlesForm extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Card className={isCollapsed ? 'sticky-top search-articles-form' : 'search-articles-form'}>
...
SearchArticlesForm.defaultProps = {
  currentPage: 1,
  disabled: false,
  request: null,
  selectedRows: [],
