...
class PreviewComponent extends React.Component {
  static propTypes = {
    handleGetArticleNode: PropTypes.func.isRequired,
  ...
  componentDidMount() {
    const { handleGetArticleNode, handleGetImageNode, image, imageRef, node, nodeRef } = this.props;
    if (!image && imageRef) {
