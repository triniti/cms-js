...
class PreviewComponent extends React.Component {
  static propTypes = {
    handleGetAudioNode: PropTypes.func.isRequired,
  ...
  componentDidMount() {
    const { handleGetAudioNode, handleGetImageNode, image, imageRef, node, nodeRef } = this.props;
    if (!image && imageRef) {
