...
class PreviewComponent extends React.Component {
  static propTypes = {
    handleGetGalleryNode: PropTypes.func.isRequired,
  ...
  componentDidMount() {
    const { handleGetGalleryNode, handleGetImageNode, image, imageRef, node, nodeRef } = this.props;
    if (!image && imageRef) {
