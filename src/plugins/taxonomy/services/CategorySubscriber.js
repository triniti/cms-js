...
export default class CategorySubscriber extends EventSubscriber {
  constructor() {
    super();
  ...
  getSubscribedEvents() {
    return {
      'triniti:taxonomy:mixin:category.init_form': this.onInitForm,
      'triniti:taxonomy:mixin:category.validate_form': this.onValidateForm,
      'triniti:taxonomy:mixin:category.submit_form': this.onSubmitForm,
    };
  }
}
