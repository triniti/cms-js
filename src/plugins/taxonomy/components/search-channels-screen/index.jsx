...
import SearchForm from '@triniti/cms/plugins/taxonomy/components/search-channels-screen/SearchForm';
...
const CreateChannelModal = lazy(() => import('@triniti/cms/plugins/taxonomy/components/create-channel-modal'));
