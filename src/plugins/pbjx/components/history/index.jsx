...
class History extends React.Component {
  ...
  render() {
    ...
    return <EventStream events={events} getUser={getUser} status={status} exception={exception} response={response} onLoadMore={() => delegate.handleLoadMore(streamId, schema, response.get('last_occurred_at'))} />;
  }
}
