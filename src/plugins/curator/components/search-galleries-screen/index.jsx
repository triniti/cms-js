...
import SearchForm from '@triniti/cms/plugins/news/components/search-articles-screen/SearchForm';
...
const CreateGalleryModal = lazy(() => import('@triniti/cms/plugins/curator/components/create-gallery-modal'));
