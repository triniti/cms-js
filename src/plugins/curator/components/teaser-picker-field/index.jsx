...
const TeaserPickerField = (props) => {
  ...
  return (
    <>
      ...
      <Label>{`search and select ${isMulti ? 'teasers' : 'a teaser'}`}</Label>
      <NodePickerField
        {...props}
        className="mb-4"
        constants={constants}
...
TeaserPickerField.defaultProps = {
  disabled: false,
  isEditMode: true,
  isMulti: true,
};

export default TeaserPickerField;
