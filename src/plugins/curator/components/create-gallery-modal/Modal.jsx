...
import Form from '@triniti/cms/plugins/curator/components/create-gallery-modal/Form';
...
)((props) => <CreateNodeModal formComponent={Form} headerText="Create Gallery" {...props} />));
