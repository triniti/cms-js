...
const BlogrollWidgetFields = ({ isEditMode, formValues, node, type }) => (
  <Card>
    ...
    <CardBody indent>
      ...
      <Field
        component={TextField}
        label="Promotion Slot Prefix"
        name="promotionSlotPrefix"
        placeholder="Enter Promotion Slot Prefix"
        readOnly={!isEditMode}
      />
      ...
      && (
        <Field
          ...
          label="Theme"
          name="theme"
          picklistId="blogroll-widget-themes"
        />
      )}
      <Field
        component={TextField}
...
BlogrollWidgetFields.propTypes = {
...
BlogrollWidgetFields.defaultProps = {
  formValues: null,
  isEditMode: false,
};

export default connect(selector)(BlogrollWidgetFields);
