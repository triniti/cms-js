...
const GridlerWidgetFields = ({ formValues, isEditMode, node, type }) => (
  <Card>
    ...
    <CardBody indent>
      ...
      <Field
        ...
        label="Theme"
        name="theme"
        picklistId="gridler-widget-themes"
      />
      )}
      <Field
        component={TextField}
...
GridlerWidgetFields.defaultProps = {
  formValues: null,
  isEditMode: false,
};

export default connect(selector)(GridlerWidgetFields);
