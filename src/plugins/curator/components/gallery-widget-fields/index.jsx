...
const GalleryWidgetFields = ({ formValues, isEditMode, node, type }) => (
  <Card>
    ...
    <CardBody indent>
      ...
      {hasThemeableMixin(type, node)
        ...
        <Field
          ...
          label="Theme"
          name="theme"
          picklistId="gallery-widget-themes"
        />
        )}
      <Field
        component={TextField}
...
GalleryWidgetFields.defaultProps = {
  formValues: null,
  isEditMode: false,
};

export default connect(selector)(GalleryWidgetFields);
