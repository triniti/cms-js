...
import SearchSortEnum from '@triniti/schemas/triniti/curator/enums/SearchTimelinesSort';
import {
  Button,
  Card,
  CardBody,
...
class SearchTimelinesForm extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Card className={isCollapsed ? 'sticky-top search-timelines-form' : 'search-timelines-form'}>
          ...
          <Form autoComplete="off" onSubmit={(e) => e.preventDefault()}>
            <InputGroup>
              ...
              <InputGroupAddon addonType="append">
                <Button disabled={disabled} color="secondary" onClick={this.handleMakeRequest}>
...
SearchTimelinesForm.defaultProps = {
  currentPage: 1,
  disabled: false,
  request: {},
  selectedRows: [],
...
export default SearchTimelinesForm;
