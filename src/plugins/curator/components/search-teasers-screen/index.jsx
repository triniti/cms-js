...
import SearchForm from '@triniti/cms/plugins/curator/components/search-teasers-screen/SearchForm';
...
const CreateTeaserModal = lazy(() => import('@triniti/cms/plugins/curator/components/create-teaser-modal'));
