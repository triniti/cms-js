...
export default function SearchForm(props) {
  ...
  delegate.handleResetFilters = (event) => {
    ...
    values.count = 25;
    values.sort = SearchTimelinesSort.RELEVANCE.getValue();
    form.reset(values);
    form.submit();
  };
      ...
      <Card>
        <CardBody>
          <InputGroup>
            ...
            <NodeStatusField />
            <Field name="q" type="search" component="input" className="form-control" placeholder="Search Timelines" />
        ...
        <Collapse isOpen={isOpen}>
          <CardBody className="pt-1 pb-0">
            ...
            <Row>
              ...
              <Col sm={6} xl={3}>
                <SortField enumClass={SearchTimelinesSort} />
              </Col>
              <Col sm={6} xl={3}>
