...
import SearchForm from '@triniti/cms/plugins/curator/components/search-timelines-screen/SearchForm';
...
const CreateTimelineModal = lazy(() => import('@triniti/cms/plugins/curator/components/create-timeline-modal'));
...
function SearchTimelinesScreen(props) {
  ...
  const canDelete = policy.isGranted(`${APP_VENDOR}:timeline:delete`);
