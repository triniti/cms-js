...
const AlertWidgetFields = ({ formValues, isEditMode, node, type }) => (
  <Card>
    ...
    <CardBody indent>
      ...
      <Field
        ...
        label="Theme"
        name="theme"
        picklistId="alert-widget-themes"
      />
      )}
      <Field
        component={TextField}
...
AlertWidgetFields.defaultProps = {
  formValues: null,
  isEditMode: false,
};

export default connect(selector)(AlertWidgetFields);
