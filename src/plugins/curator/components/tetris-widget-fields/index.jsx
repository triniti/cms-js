...
const TetrisWidgetFields = ({ formValues, isEditMode, node, type }) => (
  <Card>
    ...
    <CardBody indent>
      ...
      <Field
        ...
        label="Layout"
        name="layout"
        picklistId="tetris-widget-layouts"
      />
      ...
      <Field
        ...
        label="Theme"
        name="theme"
        picklistId="tetris-widget-themes"
      />
      )}
      <Field
        component={TextField}
...
TetrisWidgetFields.defaultProps = {
  formValues: null,
  isEditMode: false,
};

export default connect(selector)(TetrisWidgetFields);
