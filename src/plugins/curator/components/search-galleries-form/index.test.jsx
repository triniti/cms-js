...
import SearchGalleriesForm from './index';
...
const q = '';
const request = SearchGalleriesRequestV1Mixin.findOne().createMessage();
const sort = '';
const statuses = [];
const view = 'card';

const wrapper = shallow(<SearchGalleriesForm
  currentPage={1}
  disabled={disabled}
  getNode={getNode}
  inputRef={inputRef}
...
test('SearchGalleriesForm render', (t) => {
...
test('SearchGalleriesForm DropdownItem onClick test', (t) => {
...
test('SearchGalleriesForm Field onChange test', (t) => {
