...
class SearchGalleriesForm extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Card className={isCollapsed ? 'sticky-top search-galleries-form' : 'search-galleries-form'}>
...
SearchGalleriesForm.defaultProps = {
  currentPage: 1,
  disabled: false,
  request: null,
  selectedRows: [],
...
export default SearchGalleriesForm;
