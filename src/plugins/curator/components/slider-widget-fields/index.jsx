...
const SliderWidgetFields = ({ formValues, isEditMode, node, type }) => (
  <Card>
    ...
    <CardBody indent>
      ...
      <Field
        ...
        label="Theme"
        name="theme"
        picklistId="slider-widget-themes"
      />
      )}
      <Field
        component={TextField}
...
SliderWidgetFields.defaultProps = {
  formValues: null,
  isEditMode: false,
};

export default connect(selector)(SliderWidgetFields);
