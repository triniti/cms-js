...
function SearchTeasersRequestFields(props) {
  ...
  return (
    <>
      ...
      <TimelinePickerField
        nestedPbj={pbj}
        pbjName="timeline_ref"
        name="search_request.timeline_ref"
        label="Timeline"
      />
      ...
      <GalleryPickerField
        nestedPbj={pbj}
        pbjName="gallery_ref"
        name="search_request.gallery_ref"
        label="Gallery"
      />
...
export default withPbj(SearchTeasersRequestFields, 'triniti:curator:request:search-teasers-request:v1');
