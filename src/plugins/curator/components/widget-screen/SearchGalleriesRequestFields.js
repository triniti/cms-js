...
function SearchGalleriesRequestFields(props) {
  const { pbj } = props;
...
export default withPbj(SearchGalleriesRequestFields, 'triniti:curator:request:search-galleries-request:v1');
