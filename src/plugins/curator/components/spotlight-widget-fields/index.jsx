...
const SpotlightWidgetFields = ({ formValues, isEditMode, node, type }) => (
  <Card>
    ...
    <CardBody indent>
      ...
      <Field
        ...
        label="Theme"
        name="theme"
        picklistId="spotlight-widget-themes"
      />
      )}
      <Field
        component={TextField}
...
SpotlightWidgetFields.propTypes = {
...
SpotlightWidgetFields.defaultProps = {
  formValues: null,
  isEditMode: false,
};

export default connect(selector)(SpotlightWidgetFields);
