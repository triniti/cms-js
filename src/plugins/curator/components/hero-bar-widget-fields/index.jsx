...
const HeroBarWidgetFields = ({ formValues, isEditMode, node, type }) => (
  <Card>
    ...
    <CardBody indent>
      ...
      <Field
        ...
        label="Theme"
        name="theme"
        picklistId="hero-bar-widget-themes"
      />
      )}
      <Field
        component={TextField}
...
HeroBarWidgetFields.defaultProps = {
  formValues: null,
  isEditMode: false,
};

export default connect(selector)(HeroBarWidgetFields);
