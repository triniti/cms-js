...
const MediaListWidgetFields = ({ formValues, isEditMode, node, type }) => (
  <Card>
    ...
    <CardBody indent>
      ...
      <Field
        ...
        label="Theme"
        name="theme"
        picklistId="media-list-widget-themes"
      />
      )}
      <Field
        component={TextField}
...
MediaListWidgetFields.propTypes = {
...
MediaListWidgetFields.defaultProps = {
  formValues: null,
  isEditMode: false,
};

export default connect(selector)(MediaListWidgetFields);
