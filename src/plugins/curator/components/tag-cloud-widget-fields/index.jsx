...
const TagCloudWidgetFields = ({ formValues, isEditMode, node, type }) => (
  <Card>
    ...
    <CardBody indent>
      ...
      <Field
        ...
        label="Theme"
        name="theme"
        picklistId="tag-cloud-widget-themes"
      />
      )}
      <Field
        component={TextField}
...
TagCloudWidgetFields.propTypes = {
...
TagCloudWidgetFields.defaultProps = {
  formValues: null,
  isEditMode: false,
};

export default connect(selector)(TagCloudWidgetFields);
