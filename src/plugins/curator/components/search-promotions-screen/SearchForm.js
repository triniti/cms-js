...
import { ActionButton, DatePickerField, Icon, NumberField, SearchClearButton, useDebounce } from '@triniti/cms/components/index.js';
...
export default function SearchForm(props) {
  ...
  delegate.handleResetFilters = (event) => {
    ...
    values.count = 25;
    values.sort = SearchPromotionsSort.TITLE_ASC.getValue();
    form.reset(values);
    form.submit();
  };
        ...
        <CardBody>
          <div className="position-relative">
            <InputGroup>
              ...
              <NodeStatusField />
              <Field name="q" type="search" component="input" className="form-control" placeholder="Search Promotions" />
        ...
        <Collapse isOpen={isOpen}>
          <CardBody className="pt-1 pb-0">
            ...
            <Row>
              ...
              <Col sm={6} xl={3}>
                <SortField enumClass={SearchPromotionsSort} />
              </Col>
              <Col sm={6} xl={3}>
