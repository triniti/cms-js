...
const CarouselWidgetFields = ({ formValues, isEditMode, node, type }) => (
  <Card>
    ...
    <CardBody indent>
      ...
      <div className="pb-1 d-md-inline-flex">
        ...
        <Field
          component={CheckboxField}
          disabled={!isEditMode}
          label="Show Position Indicators"
          name="showPositionIndicators"
        />
      </div>
      <Field
        component={TextField}
      ...
      && (
        <Field
          ...
          label="Theme"
          name="theme"
          picklistId="carousel-widget-themes"
        />
      )}
      <Field
        component={TextField}
...
CarouselWidgetFields.propTypes = {
...
CarouselWidgetFields.defaultProps = {
  formValues: null,
  isEditMode: false,
};

export default connect(selector)(CarouselWidgetFields);
