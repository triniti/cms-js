...
export default class ArticleTeaserSubscriber extends EventSubscriber {
  constructor() {
    super();
  ...
  getSubscribedEvents() {
    return {
      'triniti:curator:mixin:article-teaser.init_form': this.onInitForm,
      'triniti:curator:mixin:article-teaser.validate_form': this.onValidateForm,
      'triniti:curator:mixin:article-teaser.submit_form': this.onSubmitForm,
    };
  }
}
