...
import SearchSortEnum from '@triniti/schemas/triniti/people/enums/SearchPeopleSort';
...
class SearchPeopleForm extends Component {
  ...
  render() {
    ...
    return (
      <Card className={isCollapsed ? 'sticky-top search-people-form' : 'search-people-form'}>
