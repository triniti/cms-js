...
import SearchForm from '@triniti/cms/plugins/apollo/components/search-polls-screen/SearchForm';
...
const CreatePollModal = lazy(() => import('@triniti/cms/plugins/apollo/components/create-poll-modal'));
...
function SearchPollsScreen(props) {
  ...
  const canDelete = policy.isGranted(`${APP_VENDOR}:poll:delete`);
