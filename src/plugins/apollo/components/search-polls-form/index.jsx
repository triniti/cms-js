...
class SearchPollsForm extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Card className={isCollapsed ? 'sticky-top search-polls-form' : 'search-polls-form'}>
...
export default SearchPollsForm;
