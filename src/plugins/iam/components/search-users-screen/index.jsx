...
import SearchForm from '@triniti/cms/plugins/iam/components/search-users-screen/SearchForm';

const CreateUserModal = lazy(() => import('@triniti/cms/plugins/iam/components/create-user-modal'));
