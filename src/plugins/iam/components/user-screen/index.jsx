...
import DetailsTab from '@triniti/cms/plugins/iam/components/user-screen/DetailsTab';
import RolesTab from '@triniti/cms/plugins/iam/components/user-screen/RolesTab';
