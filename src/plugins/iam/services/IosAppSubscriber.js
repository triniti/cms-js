...
export default class IosAppSubscriber extends EventSubscriber {
  constructor() {
    super();
  ...
  getSubscribedEvents() {
    return {
      'gdbots:iam:mixin:ios-app.init_form': this.onInitForm,
      'gdbots:iam:mixin:ios-app.warn_form': this.onWarnForm,
      'gdbots:iam:mixin:ios-app.validate_form': this.onValidateForm,
      'gdbots:iam:mixin:ios-app.submit_form': this.onSubmitForm,
    };
  }
}
