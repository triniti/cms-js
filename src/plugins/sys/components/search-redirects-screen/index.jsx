...
import SearchForm from '@triniti/cms/plugins/sys/components/search-redirects-screen/SearchForm';
...
const CreateRedirectModal = lazy(() => import('@triniti/cms/plugins/sys/components/create-redirect-modal'));
