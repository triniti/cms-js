...
import SearchSortEnum from '@triniti/schemas/triniti/boost/enums/SearchSponsorsSort';
import {
  Button,
  Card,
  CardBody,
...
class SearchSponsorsForm extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Card className={isCollapsed ? 'sticky-top search-sponsors-form' : 'search-sponsors-form'}>
...
SearchSponsorsForm.defaultProps = {
  currentPage: 1,
  disabled: false,
  request: {},
  selectedRows: [],
...
export default SearchSponsorsForm;
