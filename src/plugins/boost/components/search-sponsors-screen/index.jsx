...
import SearchForm from '@triniti/cms/plugins/boost/components/search-sponsors-screen/SearchForm';
...
const CreateSponsorModal = lazy(() => import('@triniti/cms/plugins/boost/components/create-sponsor-modal'));
