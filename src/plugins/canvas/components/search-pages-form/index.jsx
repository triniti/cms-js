...
import SearchSortEnum from '@triniti/schemas/triniti/canvas/enums/SearchPagesSort';
...
class SearchPagesForm extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Card className={isCollapsed ? 'sticky-top search-pages-form' : 'search-pages-form'}>
        <CardBody className="pb-1">
          ...
          >
            ...
            <div className="search-batch-and-sort-and-view pr-4">
              <SearchViewButtons schema={schemas.searchNodes} className="float-right pl-2 pt-2" />
