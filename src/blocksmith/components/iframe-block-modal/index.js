...
function IframeBlockModal() {
  return (
    <>
      ...
      <TextField name="width" label="Width" description="In pixels or percent, e.g. 200, 200px or 100%" />
      <TextField name="height" label="Height" description="In pixels or percent, e.g. 200, 200px or 100%" />
