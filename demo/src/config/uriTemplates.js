...
registerTemplates({
  ...
  // Search/List routes
  'article.search': '/news/articles',
  'asset.search': '/dam/assets',
  'gallery.search': '/curator/galleries',
  'page.search': '/canvas/pages',
  'poll.search': '/apollo/polls',
  'video.search': '/ovp/videos',
  'livestream.search': '/ovp/livestreams',
  'category.search': '/taxonomy/categories',
  'channel.search': '/taxonomy/channels',
  'person.search': '/people/people',
  'teaser.search': '/curator/teasers',
  'timeline.search': '/curator/timelines',
  'widget.search': '/curator/widgets',
  'promotion.search': '/curator/promotions',
  'sponsor.search': '/boost/sponsors',
  'notification.search': '/notify/notifications',
  ...
  [`${APP_VENDOR}:live-blog-update-teaser.canonical`]: '{+web_base_url}t/live-blog-update/{_id}/',
